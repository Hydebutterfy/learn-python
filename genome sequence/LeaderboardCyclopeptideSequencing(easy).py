    ...
    while Leaderboard != []:
        ...
        for Peptide in Leaderboard:
            if mass(Peptide) == ParentMass:
                ...
                #elif LinearScore(Peptide, Spectrum)==LinearScore(LeaderPeptide, Spectrum):
...
AA=LeaderboardCyclopeptideSequencing(experimental_spectrum,N)
